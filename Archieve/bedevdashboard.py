...
def send_email_notification(send_to,password, email_subject, body_html):
...
def landing_page():
    ...
    st.success(
        "We're committed to providing a seamless and efficient experience for all Development team members. Explore the different sections using the sidebar navigation to find what you need.")
...
def dev_tools_page():
    ...
    with search_col:
        search_query = st.text_input("**Search Tools**:", "",
                                     help="Type the name of the tool you want to search for...")
...
links = {
    ...
    "MY LEAVE": {"link": "https://sappeslb.sap.infineon.com/sap/bc/ui5_ui5/sap/z_leaverequest/index.html",
                 "icon": "paper-plane"},
    ...
    "Permission System": {"link": "https://apps.bth.infineon.com/Pms_System/Permission_NonShopfloor.aspx",
                          "icon": "unlock-alt"},
    ...
    "Batam Tableau URL": {
        ...
        "icon": "list-ul"},
    "Opcenter ODS Report": {"link": "https://tableau.infineon.com/#/site/ITFI/views/MESReportToC/BATMESreportToC",
                            "icon": "list"},
    ...
    "OEE Report": {"link": "https://tableau.infineon.com/#/site/ITFI/views/OEEReportforPOB/OEEStandardReport?:iid=1",
                   "icon": "gear"},
    ...
    "DEV CT300 Request": {
        ...
        "icon": "clipboard"},
    "PLATO": {"link": "https://mucsa1446.infineon.com/e1ns/portal/#action=clearFilter&cmd=CMD_E1ns_start_page",
              "icon": "bookmark"},
    "YIP": {"link": "https://yiphlp56.intra.infineon.com:8443/app/", "icon": "lightbulb-o"},
    "NOSTAS Request": {"link": "https://workflowgenerator.infineon.com/portal/DEV_NOSTAS_Request_eForm/home",
                       "icon": "file-text"},
    ...
    "Basic Evaluation in Automated Test System (BEAST)": {
...
def eform_page():
    ...
    <body>
        <div class="email-container">
            ...
            send_email_notification(admin_emails, password, em_notif_subject, html_body)
    ...
    <body>
        <div class="email-container">
            ...
            return send_email_notification(requestor_email, password, change_em_sub, change_html_body)
        except Exception as e:
            ...
            def extract_events(row):
                ...
                try:
                    ...
                    for i, event in enumerate(history):
                        ...
                        events.append({
                            'Time': event_time,
                            'Username': requestor if i == 0 else f"{Username} (Admin)",
